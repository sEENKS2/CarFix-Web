...
namespace Modelo.Migrations
{
    ...
    [Migration("20260916221244_AgregarMovimientosStock")]
    partial class AgregarMovimientosStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Compras.MovimientoStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MotivoReferencia")
            ...
            modelBuilder.Entity("Entidades.Facturacion.DetalleFactura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.Facturacion.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.Facturacion.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.Facturacion.DetalleFactura", b =>
                {
                    b.HasOne("Entidades.Facturacion.Factura", null)
                        .WithMany("Detalles")
